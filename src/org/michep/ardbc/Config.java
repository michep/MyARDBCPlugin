...
public class Config {
	...
	private List<String> configFieldNames = Arrays.asList("Primary Form Name", "Primary Form Result FieldID", "Primary Form Relation FieldID", "Subquery Operation", "Subquery Form Name", "Subquery Form Relation FieldID");
